...
import com.example.network.dto.HourlyForecastResponse
...
interface WeatherApiService {
    ...
    @GET("/forecasts/v1/hourly/12hour/{locationKey}?metric=true&details=true")
    suspend fun getHourlyForecast(@Path("locationKey") key: String): List<HourlyForecastResponse>
}